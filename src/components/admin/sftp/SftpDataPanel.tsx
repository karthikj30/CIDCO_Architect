      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            ...
            <code className="rounded bg-slate-100 px-1 font-mono text-xs">company / month / timestamp</code>. The
            company row above each tree is its master record.
          </p>
        </div>
                  ...
                  <div className="border-t border-slate-200 bg-slate-50 px-5 py-4">
                    ...
                    <dl className="grid gap-3 text-xs sm:grid-cols-3">
                      ...
                      <div>
                        ...
                        <dd className="mt-0.5 break-all font-mono text-slate-900">{node.company.filePath}</dd>
                      </div>
                      <div>
                        <dt className="font-semibold uppercase tracking-wide text-slate-500">Contact</dt>
                        <dd className="mt-0.5 text-slate-900">{node.company.contactEmail ?? '—'}</dd>
                      </div>
                    </dl>
