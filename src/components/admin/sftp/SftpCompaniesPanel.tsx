    ...
    <div className="w-full space-y-6">
      ...
      <form onSubmit={register} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <label htmlFor="co-path" className="mb-1 block text-xs font-medium text-slate-600">File path</label>
            <input id="co-path" required value={form.filePath} onChange={set('filePath')} className={INPUT} placeholder="/var/aqi/exports" />
            <p className="mt-1 text-[11px] text-slate-400">Where their CSV is picked up from, and written to here.</p>
          </div>
          <div>
